        ...
        taskItem = (
          <View style={styles.taskoptions}>
              <TouchableOpacity onPress={this._toggleTaskOptions}>
                <Image source={require("./assets/back.png")} style={styles.taskoptionbutton}/>
              </TouchableOpacity>

              <TouchableOpacity onPress={this._onPressEditTask}>
              <Image source={require("./assets/edit.png")} style={styles.taskoptionbutton}/>
              </TouchableOpacity>

              <TouchableOpacity onPress={this._onPressDeleteTask}>
              <Image source={require("./assets/delete.png")} style={styles.taskoptionbutton}/>
              </TouchableOpacity>

              <TouchableOpacity onPress={this._onPressCompleteTask}>
              <Image source={require("./assets/accept.png")} style={styles.taskoptionbutton}/>
              </TouchableOpacity>
          </View>
        );
      }
